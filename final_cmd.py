...
parser.add_argument('--master_summary',
                    help='Infow and outflow summary for each bank/firm. Add \'m\' to execute this part.',
                    default='xx')
parser.add_argument('--mode_of_transfer',
                    help='Heat map and deposit/withdraw statistics of bank transactions. Add \'hm\' to execute this part.',
                    default='xx')
parser.add_argument('--medium_of_transfer',
                    help='Specifically for FDRL. Add \'mt\' to execute this part.',
                    default='xx')
parser.add_argument('--types_of_tax',
                    help='Plots pie chart for tax charges. Add \'tx\' to execute this part.',
                    default='xx')
parser.add_argument('--direct_payments',
                    help='Plots bar chart for direct payments. Add \'dp\' to execute this part.',
                    default='xx')
...
def main():
    ...
    bank_choices = ['indiaforensic', 'fdrl' , 'npci', 'dsb', 'sbi', 'oxygen', 'hdfc']
    ...
    while True:
        ...
        elif args.medium_of_transfer == 'mt':
